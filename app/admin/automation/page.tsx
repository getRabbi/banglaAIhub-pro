...
export default async function AdminAutomationJobs() {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 mb-6">GitHub Actions cron থেকে চলা content automation run history.</p>
      <div className="glass-card overflow-x-auto">
        ...
        {(!jobs || jobs.length === 0) && <p className="text-center text-gray-600 py-10">কোনো automation job record নেই</p>}
      </div>
    </div>
  );
}
