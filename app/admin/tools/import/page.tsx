  ...
  return (
    <div>
      ...
      <div className="glass-card p-5 mb-4">
        <p className="text-sm text-gray-400 mb-3">CSV format: <code className="text-brand-electric">name,slug,tagline_bn,pricing,website_url,affiliate_url,category_id</code></p>
